namespace RTFExporter
{
    ...
    public class RTFText
    {
        ...
        {
            style = new RTFTextStyle(false, false, 12, "Consolas", new Color(0, 0, 0));
        ...
        {
            style = new RTFTextStyle(false, false, false, false, false, false, 12, "Consolas", Color.black, Underline.None);
            return this;
        }
        ...
        /// <returns>The RTF text object after style setted</returns>
        public RTFText SetStyle(Color color, int fontSize = 12, string fontFamily = "Consolas")
        {
        ...
        /// <param name="fontFamily">A valid font family, will use Calibri if doesn't exist and as default</param>
        /// <returns>The RTF text object after style setted</returns>
        public RTFText SetStyle(Color color, bool italic = false, bool bold = false, int fontSize = 12, string fontFamily = "Consolas")
        {
        ...
        {
            style = new RTFTextStyle(italic, bold, smallCaps, strikeThrough, allCaps, outline, 12, "Consolas", Color.black, underline);
            return this;
        }
    }
}
